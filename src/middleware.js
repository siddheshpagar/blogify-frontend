...
export function middleware(request) {
    // Get cookies using cookies-next for cross-environment compatibility
    const userToken = getCookie('userToken', { req: request });
    const adminToken = getCookie('adminToken', { req: request });
